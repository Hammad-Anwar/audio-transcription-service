package com.example.audiotranscription.transcription.whisper;
...
class WhisperTranscriptionServiceTest {
    ...
    void postsWhisperMultipartFieldsAndNormalizesVerboseJson() {
        ...
        TranscriptionResult result = service.transcribe(namedMp3());

        assertThat(result).isEqualTo(new TranscriptionResult(
                "english",
                5_352,
                List.of(
                        new TranscriptionSegmentResult(0, 0, 4_130, "The sun was setting."),
                        new TranscriptionSegmentResult(1, 4_130, 5_000, "Empty field.")
                )
        ));
        server.verify();
    }
    ...
    void timesOutWhenLocalWhisperStopsResponding() throws Exception {
        ...
        try {
            ...
            TranscriptionService timeoutService = new WhisperTranscriptionService(client);
